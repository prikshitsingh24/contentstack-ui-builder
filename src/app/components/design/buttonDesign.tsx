...
export default function ButtonDesign() {
  ...
  return (
    <div className="w-full h-full grid grid-cols-2 gap-4" onClick={(e)=>handleButtonDesignClick(e)}>
      ...
      <div className="flex flex-row border-2 h-8 border-gray-500 w-14 rounded-lg overflow-hidden">
        <button
      ...
      <div>
        ...
        <select
          ...
          className="border-2  rounded w-28 h-8 font-sans font-normal border-gray-500 focus:outline-none"
        >
          {/* Define font size options */}
